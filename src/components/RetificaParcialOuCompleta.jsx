  ...
  return (
    <section className="page-claro">
      <section id="retifica-parcial-vs-completa" className="blog-section">
        ...
        <h3 className="subtitle">1. O que é uma retífica parcial?</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">2. O que é uma retífica completa?</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">3. Quando escolher cada tipo de retífica?</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">4. Vale a pena retificar ou trocar o motor?</h3>
        <p className="paragraph">
