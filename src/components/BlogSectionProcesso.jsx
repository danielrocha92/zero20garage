    ...
    <div className="container-escuro">
      <h1 className="section-title" translate="no">Artigos do Blog</h1>
        <section id="processo-de-retifica" className="blog-section">
          ...
          <h3 className="subtitle">Introdução:</h3>
          <p className="paragraph">
          ...
          <h3 className="subtitle">1. O que é retífica de motores?</h3>
          <p className="paragraph">
          ...
          <h3 className="subtitle">2. Etapas do Processo de Retífica</h3>
          <p className="paragraph">O processo de retífica de motores é dividido em várias etapas, cada uma com sua importância para garantir a qualidade do serviço. As etapas mais comuns incluem:</p>
          ...
          <h3 className="subtitle">3. Ferramentas Usadas na Retífica de Motores</h3>
          <p className="paragraph">Para realizar a retífica de motores, os profissionais utilizam uma variedade de ferramentas especializadas, incluindo:</p>
          <ul className="section-list">
            <li>
...
export default BlogSectionProcesso;