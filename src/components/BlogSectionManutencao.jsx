  ...
  return (
    <div className="container-escuro">
      <section id="manutencao-de-motores" className="blog-section">
        ...
        <h3 className="subtitle">1. Troque o Óleo Regularmente</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">3. Fique Atento ao Filtro de Ar</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">4. Evite Dirigir de Forma Agressiva</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">5. Faça Inspeções Periódicas</h3>
        <p className="paragraph">
