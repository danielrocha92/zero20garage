...
function BlogSectionManutencao() {
  return (
    <section className="content-section">
      <section id="manutencao-de-motores" className="blog-section">
        <h2 className="section-title">Manutenção de Motores</h2>
        ...
        <h3 className="subPage-section-subtitle">1. Troque o Óleo Regularmente</h3>
        <p className="section-paragraph">
        ...
        <h3 className="subPage-section-subtitle">2. Verifique o Sistema de Arrefecimento</h3>
        <p className="section-paragraph">
        ...
        <h3 className="subPage-section-subtitle">3. Fique Atento ao Filtro de Ar</h3>
        <p className="section-paragraph">
        ...
        <h3 className="subPage-section-subtitle">4. Evite Dirigir de Forma Agressiva</h3>
        <p className="section-paragraph">
        ...
        <h3 className="subPage-section-subtitle">5. Faça Inspeções Periódicas</h3>
        <p className="section-paragraph">
...
export default BlogSectionManutencao;