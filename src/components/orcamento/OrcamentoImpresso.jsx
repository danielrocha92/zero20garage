  ...
  return (
    <div className="orcamento-impresso-container">
      ...
      <div className="orcamento-impresso-actions">
        <button className="btn btn-primary" onClick={() => generatePdf(orcamento)} disabled={isPdfGenerating}>
          {isPdfGenerating ? "Gerando PDF..." : "Gerar PDF"}
        </button>
        <button className="btn btn-primary" onClick={() => exportToExcel(orcamento)} disabled={isPdfGenerating}>
          Exportar Excel
        </button>
        <button className="btn btn-primary" onClick={handleVoltarPainel} disabled={isPdfGenerating}>
          Fechar
        </button>
      </div>
    </div>
