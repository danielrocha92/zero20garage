...
const ExportButtons = ({ historico, currentOrcamentoData }) => {
  ...
  return (
    <div className="export-buttons-container">
      ...
      <button onClick={() => exportarExcel(historico)} className="btn btn-primary">Exportar Excel</button>
      <button onClick={() => exportarPDF(historico)} className="btn btn-primary">Exportar PDF</button>
