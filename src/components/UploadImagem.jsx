  ...
  const handleFileChange = useCallback(
    async (event) => {
      ...
      try {
        ...
        // ✅ Passo 3 - usar o objeto { id, url } retornado pelo backend
        if (data?.image?.url) {
            ...
            >
              <path
                ...
                d="M4 16l4.586-4.586a2 2 0 012.828
                   0L15 16m-4-4l-4.586 4.586m4.586-4.586l.001.001m0
                   0l-4.586 4.586"
              ></path>
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
                d="M16 17v-1a4 4 0 00-4-4h-2a4 4
                   0 00-4 4v1m4 4v-1m4
                   1v-1m-2-4v-1a4 4 0 00-4-4h-2a4 4
                   0 00-4 4v1m4 4v-1m-4 1v-1"
              ></path>
            </svg>
