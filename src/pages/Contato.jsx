          ...
          <div className='info-section'>
            <div className='highlight-item'>
              ...
              <ul className="contact-list">
                <li>
                  <FaMapMarkerAlt style={{ fontSize: '2em', margin: '1rem' }}/>
                ...
                <li>
                  <FaPhoneAlt style={{ fontSize: '2em', margin: '1rem' }}/>
                  <a href="tel:+5511941097471">(11) 94109-7471</a>
                </li>
                <li>
                  <FaEnvelope style={{ fontSize: '2em', margin: '1rem' }}/>
                  <a href="mailto:contato@zero20garage.com">contato@zero20garage.com</a>
                </li>
                <li>
                  <FaWhatsapp style={{ fontSize: '2em', margin: '1rem' }}/>
                  <a
