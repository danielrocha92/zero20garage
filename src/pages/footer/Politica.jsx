...
const Privacidade = () => {
  ...
  return (
    <div id="privacy-policy-page" className="page modo-claro">
      <DynamicHeader messages={messages} />
      <Breadcrumbs />

      <main className="container-claro">
        <section className="footer-section">
          <h2 translate="no" className="title">
            Política de Privacidade - ZER0 20 GARAGE™
          </h2>

          <p translate="no" className="paragraph">
          ...
          <div className="privacy-policy-last-updated">
            ...
            <button onClick={handleContentUpdate} className="update-button">
              Atualizar data
            </button>
          </div>
        </section>
