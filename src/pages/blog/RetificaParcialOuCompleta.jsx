    ...
    <div className="blog-page-light">
      ...
      <div className="blog-container-light">
        ...
        <figure className="blog-figure-container">
          <img src={retificaParcialImg} alt="Retífica de motor sendo realizada" className="blog-featured-image" />
        </figure>

        <section className="blog-section">
          <h3 className="blog-subtitle-light">1. O que é uma retífica parcial?</h3>
          ...
          <h3 className="blog-subtitle-light">2. O que é uma retífica completa?</h3>
          <p className="blog-paragraph-light">
          ...
          <h3 className="blog-subtitle-light">3. Quando escolher cada tipo de retífica?</h3>
          <p className="blog-paragraph-light">
          ...
          <h3 className="blog-subtitle-light">4. Vale a pena retificar ou trocar o motor?</h3>
          <p className="blog-paragraph-light">
