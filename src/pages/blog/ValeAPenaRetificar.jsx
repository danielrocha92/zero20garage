  ...
  return (
    ...
    <div className="container-claro">
      <section id="custo-retifica-motor" className="blog-section">
        ...
        <h3 className="subtitle">1. Quando vale a pena retificar?</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">2. Quando é melhor trocar o motor?</h3>
        <p className="paragraph">
        ...
        <h3 className="subtitle">3. Comparativo entre retífica e troca</h3>
        <ul className="section-list">
        ...
        <h3 className="subtitle">4. Cuidados ao decidir</h3>
        <p className="paragraph">
