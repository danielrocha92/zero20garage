...
const valeAPenaRetificarImg = 'https://res.cloudinary.com/dlyeywiwk/image/upload/f_auto,q_auto/v1763429530/valeAPenaRetificarImg_p5wtyt.jpg';
    ...
    <div className="blog-page-light">
      ...
      <div className="blog-container-light">
        ...
        <figure className="blog-figure-container">
          <img src={valeAPenaRetificarImg} alt="Retífica de motor sendo realizada" className="blog-featured-image" />
        </figure>

        <section className="blog-section">
          <h3 className="blog-subtitle-light">1. Quando vale a pena retificar?</h3>
          ...
          <h3 className="blog-subtitle-light">2. Quando é melhor trocar o motor?</h3>
          <p className="blog-paragraph-light">
          ...
          <h3 className="blog-subtitle-light">3. Comparativo entre retífica e troca</h3>
          <ul className="blog-list-light">
          ...
          <h3 className="blog-subtitle-light">4. Cuidados ao decidir</h3>
          <p className="blog-paragraph-light">
