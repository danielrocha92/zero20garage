  ...
  return (
    <div className="terms-of-use-container">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">1. Aceitação dos Termos</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">2. Descrição dos Serviços</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">3. Uso do Site</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">4. Propriedade Intelectual</h3>
        <p className="terms-of-use-paragraph">
        ...
        <p className="terms-of-use-paragraph prohibited-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">5. Links para Outros Sites</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">6. Limitação de Responsabilidade</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">7. Indenização</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">8. Privacidade</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">9. Lei Aplicável e Jurisdição</h3>
        <p className="terms-of-use-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="terms-of-use-subtitle">10. Disposições Gerais</h3>
        <ul className="terms-of-use-list">
          <li>
