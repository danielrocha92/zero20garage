...
const Termos = () => {
  ...
  return (
    <div className="page">
      ...
      <h2 className="subPage-title">Termos de Uso - ZER0 20 GARAGE™</h2>
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">1. Aceitação dos Termos</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">2. Descrição dos Serviços</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">3. Uso do Site</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">4. Propriedade Intelectual</h3>
        <p className="subPage-paragraph">
        ...
        <p className="subPage-paragraph prohibited-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">5. Links para Outros Sites</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">6. Limitação de Responsabilidade</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">7. Indenização</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">8. Privacidade</h3>
        <p className="subPage-paragraph">
          A coleta e o uso de suas informações pessoais são regidos por nossa <a href="/politica-de-privacidade" className="terms-of-use-link">Política de Privacidade</a>, que é parte integrante destes Termos de Uso. Ao utilizar nosso site, você concorda com os termos de nossa Política de Privacidade.
        </p>
      </section>

      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">9. Lei Aplicável e Jurisdição</h3>
        <p className="subPage-paragraph">
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">10. Disposições Gerais</h3>
        <ul className="terms-of-use-list">
          <li>
      ...
      <section className="terms-of-use-section">
        <h3 className="subPage-subtitle">11. Contato</h3>
        <p className="subPage-paragraph">
      ...
      <p className="subPage-paragraph acknowledgment">
